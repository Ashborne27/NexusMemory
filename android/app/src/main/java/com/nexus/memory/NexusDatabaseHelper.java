...
public class NexusDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        // Utilisation de FTS5 pour une recherche ultra-rapide avec une empreinte mémoire minime (< 5 Mo)
        db.execSQL("CREATE VIRTUAL TABLE IF NOT EXISTS memories_fts USING fts5(title, content);");
    }
